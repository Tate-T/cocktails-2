(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function o(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(i){if(i.ep)return;i.ep=!0;const n=o(i);fetch(i.href,n)}})();const u={async fetchNonAlcoholicCocktails(){return(await fetch("https://www.thecocktaildb.com/api/json/v1/1/filter.php?a=Non_Alcoholic")).json()},async fetchCocktailById(e){return(await fetch(`https://www.thecocktaildb.com/api/json/v1/1/lookup.php?i=${e}`)).json()},async fetchCocktailsByName(e){return(await(await fetch(`https://www.thecocktaildb.com/api/json/v1/1/search.php?s=${e}`)).json()).drinks.filter(i=>i.strAlcoholic==="Non alcoholic")},async fetchIngredientByName(e){return(await fetch(`https://www.thecocktaildb.com/api/json/v1/1/search.php?i=${e}`)).json()}},a={COCKTAILS_STORAGE_KEY:"favoriteCocktails",INGREDIENTS_STORAGE_KEY:"favoriteIngredients",getFavorites(){return JSON.parse(localStorage.getItem(this.COCKTAILS_STORAGE_KEY))||[]},addFavorite(e){const t=this.getFavorites();t.includes(e)||(t.push(e),localStorage.setItem(this.COCKTAILS_STORAGE_KEY,JSON.stringify(t)))},removeFavorite(e){const t=this.getFavorites().filter(o=>o!==e);localStorage.setItem(this.COCKTAILS_STORAGE_KEY,JSON.stringify(t))},isFavorite(e){return this.getFavorites().includes(e)},getFavoriteIngredients(){return JSON.parse(localStorage.getItem(this.INGREDIENTS_STORAGE_KEY))||[]},addFavoriteIngredient(e){const t=this.getFavoriteIngredients(),o=e.trim();t.some(s=>s.toLowerCase()===o.toLowerCase())||(t.push(o),localStorage.setItem(this.INGREDIENTS_STORAGE_KEY,JSON.stringify(t)))},removeFavoriteIngredient(e){const t=this.getFavoriteIngredients(),o=e.trim().toLowerCase(),s=t.filter(i=>i.toLowerCase()!==o);localStorage.setItem(this.INGREDIENTS_STORAGE_KEY,JSON.stringify(s))},isIngredientFavorite(e){if(!e)return!1;const t=this.getFavoriteIngredients(),o=e.trim().toLowerCase();return t.some(s=>s.toLowerCase()===o)}},m={createCocktailItem(e){const t=a.isFavorite(e.idDrink);return`
            ...
            <div class="cocktails-modal__box">
              ...
              <div class="cocktails-modal__ingredients-box">
                ...
                <ul class="cocktails-modal__list">
                  ${t.map(s=>(a.isIngredientFavorite(s.ingredient),`
    ...
    `},renderFavoriteIngredients(e,t){if(!e){console.error("Container not found for ingredients");return}if(t.length===0){e.innerHTML=`
      ...
      `;return}e.innerHTML=t.map(o=>this.createIngredientItem(o)).join("")},getIngredientsList(e){const t=[];for(let o=1;o<=15;o++){const s=e[`strIngredient${o}`],i=e[`strMeasure${o}`];s&&t.push({ingredient:s,measure:i||""})}return t}};document.addEventListener("DOMContentLoaded",()=>{document.querySelector(".cocktails__list")&&(C(),b(),E())});async function b(){const e=document.querySelector(".header__btn"),t=document.querySelector(".header__input"),o=document.querySelector(".cocktails__list"),s=document.querySelector(".header-menu__btn"),i=document.querySelector(".header-menu__input"),n=document.querySelector(".header-menu");e.addEventListener("click",async()=>{try{const c=t.value.trim(),d=await u.fetchCocktailsByName(c);m.renderCocktailsList(o,d)}catch(c){f(o,c)}}),s.addEventListener("click",async c=>{try{const d=i.value.trim(),S=await u.fetchCocktailsByName(d);m.renderCocktailsList(o,S),n.classList.add("hidden-burger-menu")}catch(d){f(o,d)}});const r=document.querySelector(".hero__mob-box"),l=document.querySelector(".hero__letter");r&&o&&r.addEventListener("click",async c=>{if(c.target.textContent.trim())try{l.textContent=c.target.textContent.trim(),r.classList.add("mob-box-hidden");const d=await u.fetchCocktailsByName(c.target.textContent.trim());d.length===0&&f(o,"error"),m.renderCocktailsList(o,d)}catch(d){f(o,d)}})}async function C(){var t;const e=document.querySelector(".cocktails__list");if(e){try{const o=await u.fetchNonAlcoholicCocktails();if(!((t=o==null?void 0:o.drinks)!=null&&t.length)){f(e,new Error("No drinks found"));return}m.renderCocktailsList(e,o.drinks)}catch(o){f(e,o)}e.addEventListener("click",w),document.body.addEventListener("click",F)}}function E(){document.addEventListener("click",function(e){const t=e.target.closest(".js-ingredient-favorite");if(t){const o=t.dataset.ingredient;o&&(e.preventDefault(),e.stopPropagation(),console.log("Toggling favorite for ingredient:",o),_(o,t))}})}function f(e,t){console.error("Error:",t),e&&(e.innerHTML=`
    <li class="error-item">
  ...
  `)}async function w(e){var s;const t=e.target.closest(".js-learn-more"),o=e.target.closest(".js-favorite");if(t){const i=t.closest("[data-id]");if(!i)return;const n=i.dataset.id;try{const r=await u.fetchCocktailById(n);if(!((s=r==null?void 0:r.drinks)!=null&&s[0]))throw new Error("No cocktail data");const l=m.renderModal(r.drinks[0]);document.querySelectorAll(".cocktails-modal__backdrop").forEach(c=>c.remove()),document.body.insertAdjacentHTML("beforeend",l),q(n)}catch(r){console.error("Failed to fetch cocktail details:",r)}}if(o){const i=o.closest("[data-id]");if(!i)return;const n=i.dataset.id;I(n,o)}}async function F(e){var s;const t=e.target.closest(".js-ingredient-link");if(t){const i=t.dataset.ingredient;if(!i)return;try{const n=await u.fetchIngredientByName(i);if(!((s=n==null?void 0:n.ingredients)!=null&&s[0]))throw new Error("No ingredient data");document.querySelectorAll(".ingredient-modal-backdrop").forEach(l=>l.remove());const r=m.renderIngredientModal(n.ingredients[0]);document.body.insertAdjacentHTML("beforeend",r),M()}catch(n){console.error("Failed to fetch ingredient details:",n)}return}const o=e.target.closest(".js-ingredient-favorite");if(o){const i=o.dataset.ingredient;i&&_(i,o)}}function q(e){var i;const t=document.querySelector(".cocktails-modal__backdrop:not(.ingredient-modal-backdrop)");if(!t)return;setTimeout(()=>t.classList.add("is-visible"),10);const o=()=>{t.classList.remove("is-visible"),setTimeout(()=>t.remove(),300)};(i=t.querySelector(".js-modal-close"))==null||i.addEventListener("click",o),t.addEventListener("click",n=>n.target===t&&o());const s=t.querySelector(".js-favorite");s&&s.addEventListener("click",()=>{I(e,s)}),t.querySelectorAll(".js-ingredient-favorite").forEach(n=>{n.addEventListener("click",()=>{const r=n.dataset.ingredient;r&&_(r,n)})})}function M(){var s;const e=document.querySelector(".ingredient-modal-backdrop");if(!e)return;setTimeout(()=>e.classList.add("is-visible"),10);const t=()=>{e.classList.remove("is-visible"),setTimeout(()=>e.remove(),300)};(s=e.querySelector(".js-ingredient-modal-close"))==null||s.addEventListener("click",t),e.addEventListener("click",i=>i.target===e&&t());const o=e.querySelector(".js-ingredient-favorite");o&&o.addEventListener("click",()=>{const i=o.dataset.ingredient;i&&_(i,o)})}function I(e,t){if(!e)return;const s=!a.isFavorite(e);s?a.addFavorite(e):a.removeFavorite(e),t.classList.toggle("is-active",s),k(t,s),document.querySelectorAll(`
    [data-id="${e}"] .js-favorite,
    .cocktails-modal__favorite-button[data-id="${e}"]
  `).forEach(n=>{n!==t&&(n.classList.toggle("is-active",s),k(n,s))})}function _(e,t){if(!e)return;console.log("Processing favorite toggle for:",e);const s=!a.isIngredientFavorite(e);s?a.addFavoriteIngredient(e):a.removeFavoriteIngredient(e),t.classList.toggle("is-active",s),y(t,s);const i=e.toLowerCase();if(document.querySelectorAll(".js-ingredient-favorite").forEach(n=>{n!==t&&n.dataset.ingredient&&n.dataset.ingredient.toLowerCase()===i&&(n.classList.toggle("is-active",s),y(n,s)),s?(console.log("Adding to favorites:",e),a.addFavoriteIngredient(e)):(console.log("Removing from favorites:",e),a.removeFavoriteIngredient(e))}),!e){console.error("No ingredient name provided");return}}function k(e,t){const o=e.querySelector(".cocktails__favorite-title")||e,s=e.classList.contains("cocktails-modal__favorite-button");o.textContent=t?s?"Remove fav":"Remove":s?"Add to favorite":"Add to"}function y(e,t){const o=e.querySelector(".cocktails__favorite-title")||e.querySelector(".button-text")||e,s=e.classList.contains("cocktails-modal__favorite-button");o&&(o.textContent=t?s?"Remove fav":"Remove":s?"Add fav":"Add to")}const g=document.querySelectorAll(".theme-checkbox"),p=document.querySelector("body"),N=document.querySelector(".header__menu-btn"),v=document.querySelector(".header__menu-list"),T=document.querySelector(".header-menu__menu-btn"),h=document.querySelector(".header-menu__menu-list"),A=document.querySelector(".header__mobile-menu-btn"),L=document.querySelector(".header-menu"),j=document.querySelector(".header-menu__close");Object.keys(localStorage).forEach(e=>{if(e.includes("theme")){const t=JSON.parse(localStorage.getItem(e));if(localStorage.getItem(e)===null||t.themeColor==="black"){document.documentElement.style.setProperty("--black","#FCFCFC"),document.documentElement.style.setProperty("--white","#212121"),p.style.backgroundColor="#202025",g[0].checked=t.inputValue,g[1].checked=t.inputValue;let o={themeColor:"black",inputValue:g[0].checked};localStorage.setItem(e,JSON.stringify(o))}else if(t.themeColor==="white"){document.documentElement.style.setProperty("--black","#212121"),document.documentElement.style.setProperty("--white","#FCFCFC"),p.style.backgroundColor="",g[0].checked=t.inputValue,g[1].checked=t.inputValue;let o={themeColor:"white",inputValue:g[0].checked};localStorage.setItem("theme",JSON.stringify(o))}else console.log("ddd")}});g.forEach(e=>{e.addEventListener("click",()=>{if(console.log("z"),localStorage.getItem("theme")===null||JSON.parse(localStorage.getItem("theme")).themeColor==="white"){document.documentElement.style.setProperty("--black","#FCFCFC"),document.documentElement.style.setProperty("--white","#212121"),p.style.backgroundColor="#202025";let t={themeColor:"black",inputValue:e.checked};localStorage.setItem("theme",JSON.stringify(t))}else if(JSON.parse(localStorage.getItem("theme")).themeColor==="black"){document.documentElement.style.setProperty("--black","#212121"),document.documentElement.style.setProperty("--white","#FCFCFC"),p.style.backgroundColor="";let t={themeColor:"white",inputValue:e.checked};localStorage.setItem("theme",JSON.stringify(t))}})});N.addEventListener("click",()=>{v.classList.value.includes("hidden-menu-list")?v.classList.remove("hidden-menu-list"):v.classList.value.includes("hidden-menu-list")===!1&&v.classList.add("hidden-menu-list")});T.addEventListener("click",()=>{h.classList.value.includes("hidden-menu-list")?(h.classList.remove("hidden-menu-list"),document.querySelector(".header-menu__menu-btn-svg").style.transform="rotate(180deg)"):h.classList.value.includes("hidden-menu-list")===!1&&(h.classList.add("hidden-menu-list"),document.querySelector(".header-menu__menu-btn-svg").style.transform="rotate(0)")});A.addEventListener("click",()=>{L.classList.remove("hidden-burger-menu")});j.addEventListener("click",()=>{L.classList.add("hidden-burger-menu")});document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".hero__list"),t=document.querySelector(".header__input"),o=document.querySelector(".hero__open-letters svg"),s=document.querySelector(".hero__mob-box");e&&t&&e.addEventListener("click",i=>{t.value+=i.target.textContent}),o&&s&&o.addEventListener("click",()=>{s.classList.contains("mob-box-hidden")?(s.classList.remove("mob-box-hidden"),o.style.transform="rotate(180deg)",document.querySelector(".hero").style.paddingBottom="55px"):(s.classList.add("mob-box-hidden"),o.style.transform="rotate(0)",document.querySelector(".hero").style.paddingBottom=0)})});class ${constructor(){if(console.log("IngredientManager initialized"),this.container=document.querySelector(".favorite-ingredients__list"),this.pretitle=document.querySelector(".favorite-ingredients__pretitle"),console.log("Container:",this.container),console.log("Pretitle:",this.pretitle),!this.container||!this.pretitle){console.error("DOM elements not found");return}this.init()}async init(){try{const t=a.getFavoriteIngredients();if(console.log("Favorite ingredients:",t),!t.length){console.log("No favorite ingredients found"),this.showMessage("You haven't added any favorite ingredients yet");return}const o=await this.loadIngredients(t);if(o.length===0){this.showMessage("No ingredients found");return}const s=Array.from(new Map(o.map(i=>[i.strIngredient.toLowerCase(),i])).values());m.renderFavoriteIngredients(this.container,s),this.pretitle.style.display="none",this.setupEventListeners()}catch(t){this.showMessage("Failed to load favorite ingredients"),console.error("Error loading ingredients:",t)}}async loadIngredients(t){const o=[...new Set(t.map(i=>i.toLowerCase()))];return(await Promise.all(o.map(i=>u.fetchIngredientByName(i)))).filter(i=>{var n;return(n=i.ingredients)==null?void 0:n[0]}).map(i=>i.ingredients[0])}setupEventListeners(){this.container.addEventListener("click",async t=>{var i;const o=t.target.closest(".js-ingredient-details");if(o){const n=o.closest("[data-ingredient]");if(n){const r=n.dataset.ingredient;try{const l=await u.fetchIngredientByName(r);if(!((i=l==null?void 0:l.ingredients)!=null&&i[0]))throw new Error("No ingredient data");document.querySelectorAll(".ingredient-modal-backdrop").forEach(d=>d.remove());const c=m.renderIngredientModal(l.ingredients[0]);document.body.insertAdjacentHTML("beforeend",c),this.setupIngredientModal()}catch(l){console.error("Failed to fetch ingredient details:",l)}}}const s=t.target.closest(".js-ingredient-favorite");if(s){const n=s.dataset.ingredient;n&&this.toggleFavoriteIngredient(n,s)}})}setupIngredientModal(){var i;const t=document.querySelector(".ingredient-modal-backdrop");if(!t)return;setTimeout(()=>t.classList.add("is-visible"),10);const o=()=>{t.classList.remove("is-visible"),setTimeout(()=>t.remove(),300)};(i=t.querySelector(".js-ingredient-modal-close"))==null||i.addEventListener("click",o),t.addEventListener("click",n=>n.target===t&&o());const s=t.querySelector(".js-ingredient-favorite");if(s){const n=s.dataset.ingredient;s.addEventListener("click",()=>{this.toggleFavoriteIngredient(n,s)})}}toggleFavoriteIngredient(t,o){if(!t)return;const i=!a.isIngredientFavorite(t);if(i?a.addFavoriteIngredient(t):a.removeFavoriteIngredient(t),o.classList.toggle("is-active",i),this.updateIngredientButtonUI(o,i),!i&&this.container.closest(".favorite-ingredients")){const n=t.toLowerCase();Array.from(this.container.querySelectorAll("[data-ingredient]")).filter(c=>c.dataset.ingredient.toLowerCase()===n).forEach(c=>c.remove());const l=!!this.container.querySelector("li");this.pretitle.style.display=l?"none":"block",l||this.showMessage("You haven't added any favorite ingredients yet")}document.querySelectorAll(".js-ingredient-favorite").forEach(n=>{n!==o&&n.dataset.ingredient&&n.dataset.ingredient.toLowerCase()===t.toLowerCase()&&(n.classList.toggle("is-active",i),this.updateIngredientButtonUI(n,i))})}updateIngredientButtonUI(t,o){const s=t.querySelector(".cocktails__favorite-title")||t.querySelector(".button-text")||t,i=t.classList.contains("cocktails-modal__favorite-button");s&&(s.textContent=o?i?"Remove fav":"Remove":i?"Add to favorite":"Add to")}showMessage(t){this.pretitle.textContent=t,this.pretitle.style.display="block",this.container.innerHTML=""}}document.addEventListener("DOMContentLoaded",()=>{document.querySelector(".favorite-ingredients__list")&&new $});export{m as C,a as F,u as a};
